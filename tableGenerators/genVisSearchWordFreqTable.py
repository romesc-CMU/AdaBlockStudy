...
for line in master_dol: #line is going to be index key for each line
   counts[line] = [0,0,0,0,0]
   description = master_dol[line][0]
   for idx,key in enumerate(['Color','Pattern/Shape','Density','Orientation','Env. Landmark']): 
...
for k in coded_dol:
   ...
   rowsList.append([k] + counts[k] + userID)

# export data
path = './tables/'
fileName = 'wordFreqCounts.csv'

header_new = ['Index','Color','Pattern/Shape','Density','Orientation','Env. Landmark','UserID'] 
